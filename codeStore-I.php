...
<?php
	...
	$activity_id = array(1063,1288);    

	$sql = "SELECT * FROM {$wpdb->prefix}bp_activity WHERE `id` IN (".implode(', ', array_fill(0, count($activity_id), '%s')).")";
	$query = call_user_func_array(array($wpdb, 'prepare'), array_merge(array($sql), $activity_id));
...
delete_custom_posts('monthly_deposit');
exit;
?>
	  
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~ Get Url by image file name (WP) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<?php
...
$header_url = get_attachment_url_by_slug('img_data');
echo $header_url;
?>
	  
	  
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~ Delete User & Post by Id (WP) ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<?php
require_once(ABSPATH.'wp-admin/includes/user.php' );
wp_delete_user($_GET['user_ids']);
...
?>
	  ...
	  <?php
            ...
            $uploadedfile = $_FILES['thumbnailfile'];
...
function bp_custom_screen_content() {
   ...
   echo '<p>The custom content.
    ...
    $server = '212.77.226.46' ;//Address of ftp server
    $user_name = 'Tastebrandy'; // Username
    $password = 'Tor7kzobi5'; // Password
    
    $source_file = $filepath; 
    $dest = '/order_details/order-details.csv';
    ...
    ftp_close($connection);
	  ...
	  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Share Social Media by URL ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<div class="service-buttons activity_update" id="share-profile-media" style="display:none;">
  <a target="blank" class="bp-share has-popup_" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $bp_domain_url;?>" rel="facebook"><span class="fa-stack fa-lg"><i class="fa fa-facebook"></i></span></a>
  <a target="blank" class="bp-share has-popup_" href="http://twitter.com/share?text=Rohan posted an update: &amp;url=<?php echo $bp_domain_url;?>" rel="twitter"><span class="fa-stack fa-lg"><i class="fa fa-twitter"></i></span></a>
  <a target="blank" class="bp-share has-popup_" href="http://www.linkedin.com/shareArticle?url=<?php echo $bp_domain_url; ?>&amp;title=posted an update: "><span class="fa-stack fa-lg"><i class="fa fa-linkedin"></i></span></a>
  <a target="blank" class="bp-share has-popup_" href="https://api.whatsapp.com/send?text=<?php echo $bp_domain_url;?>&amp;image_sharer=1" data-action="share/whatsapp/share" rel="whatsapp"><span class="fa-stack fa-lg"><i class="fa fa-whatsapp"></i></span></a>
  <a class="bp-share bp-cpoy has-popup_" href="#" data-href="<?php echo $bp_domain_url; ?>" attr-display="no-popup"><span class="fa-stack fa-lg"><i class="fa fa-copy"></i></span></a><span class="tooltiptext tooltip-hide">Link Copied!</span>	
</div>
